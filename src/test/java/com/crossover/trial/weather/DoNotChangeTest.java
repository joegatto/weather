 ...
 *
 * These unit tests validate that the candidate hasn't change key interfaces
 * before submission. If this class failes to compile or asserts at runtime, the
 * submission will not be scored.
 *
 * To avoid creating a submission that can not be graded, don't change this file
 * and be sure to run mvn test before submission.
 */
public class DoNotChangeTest {
    ...
    /**
     * The compile time interface validator for WeatherCollector. This method
     * will NEVER been called, but must compile.
     */
    private void validateInterfaceWeatherCollector() {

        //
        // do not edit this method, if you have changed the weather collector
        // interface and this
    ...
    /**
     * The compile time interface validator for WeatherQueryEndpoint. This
     * method will NEVER been called, but must compile.
     */
    private void validateInterfaceWeatherQueryEndpoint() {

        //
        // do not change this method - if you have changed the query endpoint in
        // a way that prevents
