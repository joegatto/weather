...
public class WeatherCollectorEndpointImpl implements WeatherCollectorEndpoint {
     ...
     */
    public void addDataPoint(final String iataCode, final String pointType, final DataPoint dp)
            throws WeatherException {
     ...
     */
    public void updateAtmosphericInformation(final AtmosphericInformation ai, final String pointType,
     ...
     */
    public static Airport addAirport(final String iataCode, final double latitude, final double longitude) {
